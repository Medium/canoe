 ...
 * @param {Number=} threshold Minimum number of bytes to hold before uploading a part.
 */
function S3Stream(params, s3, threshold) {
...
S3Stream.prototype.setupQueue = function () {
  this.queue = new S3Queue(this.threshold)  // It's ok to send undefined here.
